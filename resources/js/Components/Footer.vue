    ...
    <footer class="footer_section footer_bg">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div
                        class="main_footer d-flex justify-content-between align-items-center"
                    >
                                ...
                                <div class="instagram_shop">
                                    ...
                                    <div class="instagram_inner d-flex">
                                        <div class="instagram_img">
                                            <a href="#"
                                                ><img
                                                    src="../../assets/img/others/instagram1.png"
                                                    alt=""
                                            /></a>
                                        </div>
                                        <div class="instagram_img">
                                            <a href="#"
                                                ><img
                                                    src="../../assets/img/others/instagram2.png"
                                                    alt=""
                                            /></a>
                                        </div>
                                        <div class="instagram_img">
                                            <a href="#"
                                                ><img
                                                    src="../../assets/img/others/instagram3.png"
                                                    alt=""
                                            /></a>
                                        </div>
                                        <div class="instagram_img">
                                            <a href="#"
                                                ><img
                                                    src="../../assets/img/others/instagram4.png"
                                                    alt=""
                                            /></a>
                                        </div>
                                    </div>
                    ...
                    <div class="footer_bottom">
                        <div class="copyright_right text-center">
                            <p>
                                &copy; 2021 All rights reserved This template is
